    ...
    //------- begin wrapping with Conduit here -------//
  	    {
              ...
              m_ascent_node["state/time"].set_external(&dt);
              m_ascent_node["state/cycle"].set_external(&steps);
              m_ascent_node["state/domain_id"] = myid;
              m_ascent_node["state/software"] = "laghos";
              m_ascent_node["state/title"] = "Sedov Blast Simulation";
              m_ascent_node["state/info"] = "In Situ Data Analysis";

              m_ascent_node["coordsets/coords/type"] = "explicit";
              m_ascent_node["coordsets/coords/values/x"].set_external(v_gf);
              m_ascent_node["coordsets/coords/values/y"].set_external(v_gf);
	      m_ascent_node["coordsets/coords/values/z"].set_external(v_gf);

              m_ascent_node["topologies/mesh/type"] = "structured";
              m_ascent_node["topologies/mesh/coordset"] = "coords";

              m_ascent_node["topologies/mesh/elements/dims/i"] = dim;
              m_ascent_node["topologies/mesh/elements/dims/j"] = dim;
	      m_ascent_node["topologies/mesh/elements/dims/k"] = dim;

              m_ascent_node["fields/velocity/association"] = "vertex";
              m_ascent_node["fields/velocity/topology"]    = "mesh";
              m_ascent_node["fields/velocity/values/u"].set_external(e_gf);
	      m_ascent_node["fields/velocity/values/v"].set_external(e_gf);
	      m_ascent_node["fields/velocity/values/w"].set_external(e_gf);
            }
 ...
 *--------------------------------------------------------------------------*/
	    ...
	    extracts["e1/params/file"] = "auto_mem.py";
